		...
		<section class="call-to-action featured featured-secondary mb-5">
			<div class="col-sm-9 col-lg-9">
				<div class="call-to-action-content">
					...
					<p class="mb-0 text-left"><i class="fas fa-info-circle"></i> 간편하고 편리하게 온라인 카드결제를 하실 수 있습니다.</p>
					<p class="mb-0 text-left"><i class="fas fa-info-circle"></i> 수거 전에 카드단말기 사전 요청하시면 수거 시 오프라인 결제가 가능합니다.</p>
				</div>
			</div>
			<div class="col-sm-3 col-lg-3">
				<div class="call-to-action-btn">
					<a href="enter-payment.php" class="btn btn-modern text-2 btn-warning text-dark">파쇄비용 결제하기</a>
				</div>
			</div>
		</section>
