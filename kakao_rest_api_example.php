<?php //공통 : Config
$REST_API_KEY   = "ef9be647585e7fe08733b7e655c68861"; // 내 애플리케이션 > 앱 설정 > 요약 정보
$CLIENT_SECRET  = "zm5UovIv047uEdcPih25sE3AeBc9Z5Yz"; // 내 애플리케이션 > 제품 설정 > 카카오 로그인 > 보안
$REDIRECT_URI   = urlencode("https://www.hwinc.co.kr/kakao_rest_api_example.php");
?>
...
- [KOE006] 내 애플리케이션>제품 설정>카카오 로그인 > Redirect URI : https://www.hwinc.co.kr/kakao_rest_api_example.php
</pre>
