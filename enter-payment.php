			...
			<div class="col-md-8 mx-md-auto">
				...
				<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
					<div class="card border-0 bg-color-grey">
						<div class="card-body">
							<p><i class="far fa-credit-card fa-2x text-carrot"></i> <span style="font-size:x-large;">CHECKOUT</span></p>

							<p class="text-left"><i class="fas fa-arrow-circle-right"></i> 사전에 알려드린 성함과 연락처를 입력 후 결제확인 버튼을 눌러주세요</br>
								<i class="fas fa-arrow-circle-right"></i> 법인카드 결제 시 법인공인인증서가 필요할 수 있습니다
							</p>
							...
							<form action="" name="frm" method="post">
								...
								<div class="text-center">
									<input type="submit" id="submit" class="btn btn-warning text-dark btn-modern mt-2" name="submit" value="결제확인">
